#########################################################
## 21_dinucAnalysis1.R
## Dinucleotide analysis (AA/TT, AG/CT, GA/TC, GG/CC)
## (Figure 5 and Supplementary Figure S6 and Table S3-6): 20211201_nuCpos2_1.txt
library(Biostrings)
library(parallel)
library(vioplot)
library(openxlsx)
...
setwd(HOMEDIR)
OUTDIR1 <- "20211201_pattern_vs_score"
dir.create(OUTDIR1)
setwd(OUTDIR1)
PATTERNS <- c("AA", "AG", "GA", "GG", "AAA")
